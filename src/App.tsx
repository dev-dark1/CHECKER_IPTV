    ...
    <BrowserRouter>
      <div className="relative min-h-screen overflow-hidden bg-night text-slate-100">
        ...
        <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-6 md:px-6 lg:px-8">
          <header className="mb-6 flex flex-col gap-4 border border-white/10 bg-black/20 px-4 py-4 backdrop-blur-xl md:flex-row md:items-center md:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-3 self-start border border-white/10 bg-white/[0.05] px-4 py-3 font-mono text-xs uppercase tracking-[0.25em] text-slate-100 transition hover:border-neon-cyan/40 hover:text-neon-cyan"
